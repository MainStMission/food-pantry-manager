...
if ENV["SECRET_TOKEN"].blank?
  if Rails.env.production?
    # TODO find a better way to raise an error in production
    # you cannot rely on config vars in heroku during compile assets
    # https://devcenter.heroku.com/articles/rails3x-asset-pipeline-cedar#assetsprecompile-failures
    #
