...
describe TokensController do
  ...
  let(:valid_attributes) { { "household_id" => "1" } }
  ...
  #       post :create, {:token => { "household_id" => "invalid value" }}, valid_session
  #       assigns(:token).should be_a_new(Token)
  #     end
  ...
  #       Token.any_instance.should_receive(:update_attributes).with({ "household_id" => "1" })
  #       put :update, {:id => token.to_param, :token => { "household_id" => "1" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Token.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => token.to_param, :token => { "household_id" => "invalid value" }}, valid_session
  #       assigns(:token).should eq(token)
  #     end
